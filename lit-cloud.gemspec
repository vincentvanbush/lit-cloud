...
Gem::Specification.new do |s|
  ...
  s.summary     = 'Cloud translation toolkit for Lit - the database powered i18n backend'
  s.description = 'Translate your apps with even more pleasure to any language, ' \
